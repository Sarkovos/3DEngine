...
face_t cube_faces[N_CUBE_FACES] = {
    ...
    // left
    { .a = 8, .b = 2, .c = 7, .a_uv = { 0, 1 }, .b_uv = { 1, 0 }, .c_uv = { 0, 0 }, .color = 0xFFFFFFFF },
    { .a = 8, .b = 1, .c = 2, .a_uv = { 0, 1 }, .b_uv = { 1, 1 }, .c_uv = { 1, 0 }, .color = 0xFFFFFFFF },
    // top
...
int initialize_obj_file_data(char* filename)
{
    FILE* file;
    int count = 0;
